...
class RoomAvailabilityModel {
  ...
  RoomAvailabilityModel() {
    entryDateTextController.text = DateFormat('dd/MM/yyyy').format(DateTime.now());
    departureDateTextController.text = DateFormat('dd/MM/yyyy').format(DateTime.now());
  }
}
  ...
  void editEntryDate() {
    showDatePicker(
      ...
      if (value != null) {
        ...
        _model.entryDateTextController.text = DateFormat('dd/MM/yyyy').format(value);
      }
    });
  }
  ...
  void editDepartureDate() {
      showDatePicker(
        ...
        if (value != null) {
          ...
          _model.departureDateTextController.text = DateFormat('dd/MM/yyyy').format(value);
        }
      });
  }

  void search() {
    BlocProvider.of<AppBloc>(prefs.context()).add(AppEventLoading(model.tr('Querying'), '/engine/hotel/room-availability.php',
        {
